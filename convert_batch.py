...
def parse_args():
    ...
    parser.add_argument("-c", "--ckpt_path", default="./pretrained/fragment.pt")
    parser.add_argument("-w", "--wav2vec_path", default="./pretrained/wav2vec_small.pt")
    parser.add_argument("-v", "--vocoder_path", default="./pretrained/vocoder.pt")
...
def main(
    ...
    **kwargs,
    ...
    model = FragmentVC()  # Replace YourModelClass with the actual class name of your model
